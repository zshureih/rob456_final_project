...
class GlobalPlanner(object):
    def __init__(self):
        ...
        self.cost_map = None
        self.odom_pos = None
        self.goal_pos = (1, 1)  #started with this based on the need to have 1,1 as one of our homeworks.
        self.start_pos = (0,0)  #testing with randome variables to get the robot moving.
        self.sub_goal = (0,0)   #cannot be none due to error in the lack of return. perhaps python2 exclusive. 
